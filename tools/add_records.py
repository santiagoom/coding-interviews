...
if flag:
    ...
    home_path = "/Users/tianm/repos/coding-interviews"
    ...
    for current in selects:
        ...
        for each in lists:
            ...
            if (each == 3):
                ...
                solutison_cpp_practise_test = os.path.join(cpp_dir, current + "_practise_test.cpp")
                ...
                if not os.path.exists(solutison_cpp_practise_test):
                    # if True:
                    with open(solutison_cpp_practise_test, "w") as file:
                        file.write(CPP_HEADER)
                ...
                # if True:
                    with open(solutison_cpp_CMakeLists, "w") as file:
                        ...
                        file.write(
                            "add_executable(" + current + "_practise_test " + current + "_practise_test.cpp ${SOURCE_FILES} ${SOURCES})\n")
